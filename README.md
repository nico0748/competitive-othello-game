...
| No | 機能名 | 内容 |
|----|---------|------|
| 8 | 人 vs CPU モード | 簡単なAI（ランダム or 置ける手の中で最適手を選ぶ） |
| 9 | CPU vs CPU モード | 自動で試合を進行させる |
| 10 | 対戦結果ログ保存 | 勝敗や日付を外部ファイル（txt, csv）に保存 |
| 11 | セーブ／ロード機能 | 盤面状態をファイルに保存／復元 |
| 12 | リプレイ機能 | 対戦の手順を再生する |
| 13 | プレイヤー名入力 | プレイヤーの名前を設定・表示 |
